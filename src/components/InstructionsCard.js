    ...
    <div className="hidden lg:block w-64 min-h-[300px]">
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <li>Set your average kill time (minutes and seconds). This will be used to calculate average GP / hour.</li>
          <li>
            Add drops to your log by entering the kill number, selecting the drop, sale price, and clicking "Add Drop".
          </li>
          <li>
            For bosses with common drops stored in chest, you can enter the value of the chest and it will be calculated together together with your rare drops. (optional)
          </li>
